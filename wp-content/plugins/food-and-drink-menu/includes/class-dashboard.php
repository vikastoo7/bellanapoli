		...
		<div id="fdm-dashboard-content-area">
			...
			<div id="fdm-dashboard-content-left">
				...
				<?php if ( ! $permission or get_option("FDM_Trial_Happening") == "Yes") {
					...
					$premium_info .= sprintf( __( '<a href="%s" target="_blank">Visit our website</a> to learn how to upgrade to premium.'), 'https://www.fivestarplugins.com/premium-upgrade-instructions/?utm_source=fdm_dashboard&utm_content=visit_our_site_link' );
					$premium_info .= '</div>';
					$premium_info .= '</div>';

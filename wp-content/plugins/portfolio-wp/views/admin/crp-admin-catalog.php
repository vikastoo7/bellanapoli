        ...
        <div class="crp-project-details-wrapper">
            <aside class="crp-project-details-sidebar">
                <div id="crp-project-details-content">
                    ...
                    <input id="crp-project-url" name="project.url" value="" type="text" placeholder="Link: e.g. https://yourdomain.com/checkout">
                    <input class="crp-fullwidth-input" id="crp-project-price" name="project.price" value="" type="text" placeholder="Price: Number e.g. 2100">
                    <input class="crp-fullwidth-input" id="crp-project-sale" name="project.sale" value="" type="text" placeholder="Sale (%): Number e.g. 10">
                </div>
            </aside>
...
function crp_updateModel(){
  //To make sure it's valid JS object
    ...
    crp_portfolio.extoptions = {
        all_cats: {},
        type: '<?php echo esc_attr(CRPGridType::CATALOG); ?>'
    };
    ...
    if(crp_selectedProjectId){
        ...
        var details = {
            ...
            status: '<?php echo esc_attr(CRPProductStatus::Visible); ?>'
        };

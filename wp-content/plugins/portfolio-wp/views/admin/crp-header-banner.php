...
<?php
    ...
    if (!empty($gkitBanner)) {
        echo wp_kses($gkitBanner['content'], GKIT_ALLOWED_BANNER_HTML);
    } else {
?>
        <style>
            ...
            .gkit-default-banner-box--logo {
                background-image: url('<?php echo esc_url(CRP_IMAGES_URL.'/admin/banner/logo.png'); ?>');
                width: 70px;
                height: 70px;
            }
            ...
            .gkit-default-banner-box--title-block-icon {
                background-image: url('<?php echo esc_url(CRP_IMAGES_URL.'/admin/banner/gridkit.png'); ?>');
                width: 220px;
                height: 70px;
                margin: 0 auto;
            }
            ...
            .gkit-default-banner-box--menu-block-help {
                background-image: url('<?php echo esc_url(CRP_IMAGES_URL.'/admin/banner/support.png'); ?>');
                margin-top: -60px;
                width: 45px;
                height: 45px;
                margin-right: 20px;
